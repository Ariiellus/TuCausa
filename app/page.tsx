  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16">
            ...
            <h2 className="text-3xl font-bold text-foreground mb-4">{t('features.why_choose_title')}</h2>
      ...
      <section className="bg-muted py-16">
        <div className="container mx-auto px-4">
                      <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-foreground mb-4">{t('how_it_works.title')}</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
      ...
      {/* CTA Section */}
          ...
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground mb-4">{t('cta.ready_title')}</h2>
      ...
      {/* Footer */}
          ...
          <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <p className="text-sm text-muted-foreground">{t('footer.powered_by')}</p>
            </div>
          </div>
        </footer>
    </div>
